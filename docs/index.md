...
-   :material-tooltip-question-outline:{.lg .middle} __为什么要使用 MkDocs__

    ---

    - [x] 使用 Markdown 作为标记语言，虽没有 Sphinx 的 RestructuredText 强大，但容易上手，且对中文较为友好。
    - [x] 丰富的 Markdown 扩展，足以满足日常文档需求。
    - [x] 配置文件使用 YAML，相比 Sphinx 使用 Python 源码进行配置相对简单。
    - [x] 强大的离线搜索功能，以及基本的中文关键词搜索支持。
    - [x] 标题 permalink anchor 支持 Unicode 字符（Sphinx 仅支持 ASCII）。

</div>

## MkDocs 插件链

本人在使用 MkDocs 时，用到以下几个插件，其中有两个是偶然看到 [TonyCrane](https://note.tonycrane.cc/) 博主的博客后，觉得他自己写的插件很好用，也拿来的使用了:
...
<div align='center'>
  <div style='display: inline-block;'>
    <img alt='alipay' src='./assets/pays/alipay.jpg' width=200 height=200 />
    <div>支付宝</div>
  </div>

  <div style='display: inline-block;'>
    <img alt='wechat' src='./assets/pays/wechatpay.jpg' width=200 height=200 />
    <div>微信</div>
  </div>
</div>
